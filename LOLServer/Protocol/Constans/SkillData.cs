...
// **********************************************************************
// 
// 文件名(File Name)：			SkillData.cs
// 
// 作者(Author)：				da_fei
// 
// 创建时间(CreateTime):			2016-01-26 16:30:25Z
//
// 描述(Description):			SkillData 技能数据				
//
// **********************************************************************
    ...
    public class SkillData
    {
        ...
        static SkillData()
        {
            ...
            create(2, "妖异狐火",
                ...
                SkillType.SELF, SkillTarget.E_H, skillLevelData(1, 0, 0, 0), skillLevelData(3, 7, 65, 880),
                skillLevelData(5, 7, 70, 880), skillLevelData(7, 7, 75, 880), skillLevelData(9, 7, 80, 880),
                skillLevelData(-1, 7, 85, 880));
            create(3, "魅惑妖术",
                "消耗 85/85/85/85/85法力 \n冷却 12/12/12/12/12 \n射程 975 \n效果 阿狸献出红唇热吻，对命中的第一个敌人造成60/90/120/150/200(+0.5)魔法伤害并将目标魅惑，让目标意乱情迷地走向阿狸。魅惑效果持续1/1.25/1.5/1.75/2秒。",
                SkillType.POSITION, SkillTarget.E_H, skillLevelData(1, 0, 0, 0), skillLevelData(3, 7, 65, 880),
                skillLevelData(5, 7, 70, 880), skillLevelData(7, 7, 75, 880), skillLevelData(9, 7, 80, 880),
                skillLevelData(-1, 7, 85, 880));
            create(4, "灵魂突袭",
